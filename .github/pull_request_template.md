...
- [ ] If determinism/time/threading touched: docs updated
- [ ] Change is submitted through PR (no direct push to `main`)
- [ ] Commits are signed and show as verified in GitHub
